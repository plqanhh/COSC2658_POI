...
public class DataGenerator {
    ...
    public static void main(String[] args) {
        try {
            String filename = "src\\Nhan_\\placesLarge.txt";
            int numberOfPlaces = 100000000; // Number of places to generate
            int mapSize = 10000000; // Reduced map size for localized data
